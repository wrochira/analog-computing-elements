<p align="center">
    ...
    <a href="#simulation-types">Simulation Types</a> •
...
6. **Check for parameter-induced extremes** - Parameter issues can also manifest as singular matrix errors.
...
3. **Adjust the UIC directive** - The `UIC` (Use Initial Conditions) flag in the `.tran` command tells LTspice whether to use the specified initial conditions directly or to compute an operating point first:
    ...
    - All-numerical schematics often exhibit unexpected behaviour when the UIC flag is used
...
If you want to ask me about this repo, please [send me an email](mailto:william.rochira@hotmail.co.uk).
